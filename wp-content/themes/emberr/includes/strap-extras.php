...
function bootstrap_styles()
{
    ...
    wp_register_style( 'font-awesome', get_template_directory_uri() . '/css/font-awesome.css', array(), '3.0.1', 'all' );
	wp_register_style( 'colorbox', get_template_directory_uri() . '/css/colorbox.css', array(), '1.3.19', 'all' );
    wp_register_style( 'responsive-style', get_stylesheet_uri(), false, '1.2.0' );
