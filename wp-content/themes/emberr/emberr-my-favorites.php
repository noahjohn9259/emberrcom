        ...
        <div class="span9 clearfix">
            ...
            <div class="bs-docs-example">
                <ul id="myTab" class="nav nav-tabs nav_style_border">
                    ...
                    <li class="active"><a href="#my_favorites" data-toggle="tab"><i class="icon-star color_star "></i>My Favorites(11)</a></li>
                </ul>
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="my_favorites">
