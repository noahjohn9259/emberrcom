<?php
    ...
    * @file           emberr-search-results.php
    */
    ?>
                    ...
                    <div class="tab-pane fade in active" id="active">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="Favorites_img">
                                        <img class="fav_img" src="<?php echo get_template_directory_uri().'/' ?>includes/css/images/favorites_pic5.png" />This is another test title listing</br>
                                        <p class="title_note">Community - Classes</p>
                                    </td>
                                    <td>$250.00</td>
                                    <td>Los Angeles</td>
